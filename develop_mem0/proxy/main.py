...
from develop_mem0 import Memory, MemoryClient
from develop_mem0.configs.prompts import MEMORY_ANSWER_PROMPT
from develop_mem0.memory.telemetry import capture_client_event, capture_event
...
class Completions:
    ...
    def _format_query_with_memories(self, messages, relevant_memories):
        ...
        entities = []
        if isinstance(self.mem0_client, develop_mem0.memory.main.Memory):
        ...
        elif isinstance(self.mem0_client, develop_mem0.client.main.MemoryClient):
